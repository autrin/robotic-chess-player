...
class Orchestrator:
    def __init__(self, armature: Armature, min_duration_secs: float = 1.25):
    ...
    def pick_and_drop_sequence(self, start_square: str, end_square: str, home_waypoint: Waypoint = HOME_WAYPOINT) -> 'Orchestrator':
