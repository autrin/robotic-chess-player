...
MARGIN_OF_ERROR_HEIGHT_OFFSET = 0.002
...
a1 = Skeleton.forward_kinematics(JointVector.from_topic([1.8095367590533655, -0.8377025884440918, 0.9908225536346436, -2.557741781274313, -1.5800336042987269, -0.311380688344137]))[-1]
h1 = Skeleton.forward_kinematics(JointVector.from_topic([0.5234759489642542, -0.2371109288981934, 1.0894415378570557, -1.8760134182372035, -1.550518814717428, -0.19458419481386358]))[-1]
h8 = Skeleton.forward_kinematics(JointVector.from_topic([0.37623769441713506, -0.1649351877025147, 1.410502552986145, -1.811185976068014, -1.5535910765277308, 0.14262129366397858]))[-1]
a8 = Skeleton.forward_kinematics(JointVector.from_topic([1.7017152945147913, -0.7957399052432557, 1.4398081302642822, -2.4622489414610804, -1.5409234205829065, 0.11539431661367416]))[-1]
...
for i, file in enumerate(files):
    for rank in range(1, 9):
        ...
        pos += np.array([0, 0, MARGIN_OF_ERROR_HEIGHT_OFFSET])
